...
// Importation pour la sélection de fichier
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: Text('Import Photo', style: TextStyle(color: Colors.black)),
                onTap: () {
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color.fromARGB(255, 255, 253, 255).withOpacity(0.2),
                        blurRadius: 10,
                        offset: Offset(0, 5),
                      ),
                    ],
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(width: 2, color: Color.fromARGB(168, 31, 108, 181)),
                          ...
                          child: Stack(
                            children: [
                              ...
                              Align(
                                ...
                                child: Icon(Icons.camera_alt, size: 40, color: const Color.fromARGB(255, 0, 0, 0)),
                              ),
